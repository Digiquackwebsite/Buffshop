...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
    ...
    <div class="sidebar-brand-text mx-3">Master Vendor<sup></sup></div>
</a>
...
<li class="nav-item">
    <!-- <a class="nav-link" href="{{ route('vendors') }}">
        <i class="fas fa-fw fa-tachometer-alt"></i>
        <span>Vendors</span></a> -->
        <a class="nav-link" href="{{ route('vendor.customerdata') }}">
        <i class="fas fa-fw fa-tachometer-alt"></i>
        <span>Customers</span></a>
        <a class="nav-link" href="{{ route('vendor.warrantycards') }}">
        <i class="fas fa-fw fa-tachometer-alt"></i>

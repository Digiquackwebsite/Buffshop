                                    ...
                                    <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <label for="service">Service Availed</label>
                                                ...
                                                <!-- amc radio buttons 1 and 2 year strt -->
                                                <div id="AMC-form" class="dynamic-form">
                                                  
                                                  <div class="form-check pt-2" class="dynamic-form">
                                                   <?php define('flexRadioDefaultAMC', 'some_value'); ?>
                                                         <input class="form-check-input" onclick="selectPPFYear(1)" type="radio" name="amcyear" value="1" id="flexRadioDefaultAMC1" checked>
                                                         <label class="form-check-label radio-font" for="flexRadioDefaultAMC1">
                                                         1Yrs Warranty
                                                         </label>
                                                         &nbsp; &nbsp; &nbsp; &nbsp;
                                                         <input class="form-check-input" onclick="selectPPFYear(2)" type="radio" name="amcyear" value="2" id="flexRadioDefaultAMC2" >
                                                         <label class="form-check-label radio-font" for="flexRadioDefaultAMC2">
                                                         2Yrs Warranty
                                                         </label>
                                                ...
                                                <!--   amc radio buttons 1 and 2 year end -->
                                                <div id="PPF-form" class="dynamic-form">
                                                  ...
                                                  <div class="form-check pt-2" class="dynamic-form">
                                                   <?php define('flexRadioDefault', 'some_value'); ?>
                                                         ...
                                                         &nbsp; &nbsp; &nbsp; &nbsp;
                                                         <input class="form-check-input" onclick="selectPPFYear(4)" type="radio" name="ppfyear" value="4" id="flexRadioDefault2" >
                                                         <label class="form-check-label radio-font" for="flexRadioDefault2">
                                                         4Yrs Warranty
                                                         </label>
                                                            </br>
                                                         <input class="form-check-input" onclick="selectPPFYear(5)" type="radio" name="ppfyear" value="5" id="flexRadioDefault3" >
                                                         <label class="form-check-label radio-font" for="flexRadioDefault3">
                                                         5Yrs Warranty
                                                         </label>
